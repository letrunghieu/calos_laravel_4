...
class Gravatar extends Thomaswelton\LaravelGravatar\Facades\Gravatar{
	 ...
	 */
	 public static function src($email, $size = null){
		 Thomaswelton\LaravelGravatar\Gravatar::src($email, $size);
	 }
	 ...
	 * @static 
	 */
	 public static function image($email, $alt = null, $attributes = array()){
		 Thomaswelton\LaravelGravatar\Gravatar::image($email, $alt, $attributes);
	 }
	 ...
	 */
	 public static function getAvatarSize(){
		//Method inherited from emberlabs\GravatarLib\Gravatar
